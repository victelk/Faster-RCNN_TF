...
if [ -d "$CUDA_PATH" ]; then
	nvcc -std=c++11 -c -o roi_pooling_op.cu.o roi_pooling_op_gpu.cu.cc \
		-I $TF_INC -I /home/victore/tensorflow/lib/python3.5/site-packages/tensorflow/include/external/nsync/public/ \
		-D GOOGLE_CUDA=1 -x cu -Xcompiler -fPIC $CXXFLAGS \
		-arch=sm_37

	g++ -std=c++11 -shared -o roi_pooling.so roi_pooling_op.cc \
		roi_pooling_op.cu.o -I $TF_INC -I /home/victore/tensorflow/lib/python3.5/site-packages/tensorflow/include/external/nsync/public/ \
		 -D GOOGLE_CUDA=1 -D _GLIBCXX_USE_CXX11_ABI=0 -fPIC $CXXFLAGS \
